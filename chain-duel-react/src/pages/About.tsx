            ...
            >
              <div className="page-inner">
                ...
                <p className="text-upscale">
                  Chain Duel is a Lightning-native game that combines the
                  timeless appeal of the classic Snake game with the world of
                  competitive gaming and Bitcoin.
                </p>
                <p>
                  In Chain Duel, two players engage in a head-to-head showdown
                  where Lightning payments are placed as bets before the game
                  begins and attempt to be the Chain with the most Proof of Work
                  by capturing the upcoming coinbases. The winner takes home the
                  combined deposits, minus a small fee.
                </p>
              </div>
              ...
              <div className="page-inner">
                <div className="mb-30">
                  ...
                  <img
                    ...
                    src="/images/sponsors/bitcoin_magazine.svg"
                    alt="Bitcoin Magazine"
                  />
                  <img
                    className="inline-logo"
                    src="/images/sponsors/piratehash.png"
                    alt="PirateHash"
                  />
                  <img
                    className="inline-logo"
                    src="/images/sponsors/bitbox.png"
                    alt="BitBox"
                  />
                  <img
                    className="inline-logo"
                    src="/images/sponsors/relai_bg.svg"
                    alt="Relai"
                  />
                </div>
                ...
                <div>
                  ...
                  <p>
                    The architecture integrates multiple open-source projects
                    and encourages the adoption of Bitcoin as a payment system.
                  </p>
                  <img
                    className="inline-logo"
                    src="/images/about/bitcoin_core.png"
                    alt="Bitcoin Core"
                  />
                  <img
                    className="inline-logo"
                    src="/images/about/lnd.png"
                    alt="LND"
                  />
                  <img
                    className="inline-logo"
                    src="/images/about/rtl.png"
                    alt="RTL"
                  />
                  <img
                    className="inline-logo"
                    src="/images/about/lnbits.png"
                    alt="LNbits"
                  />
                </div>
              </div>
            ...
            >
              <div className="page-inner">
                <div>
                  ...
                  <p>
                    A fraction of the wagered sats is distributed on Lightning
                    to the contributors of the project.
                  </p>
                  <img
                    className="value"
                    src="/images/about/value-for-value.png"
                    alt="Value for Value"
                  />
                </div>
              </div>
