...
export function ChallengeRowIcon({ id }: ChallengeRowIconProps) {
  switch (id) {
    case 'normie':
      return (
        <svg
          className="sc-row__icon sc-row__icon--normie"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
    ...
    case 'stacker':
      return (
        <svg
          className="sc-row__icon sc-row__icon--stacker"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
    ...
    case 'noderunner':
      return (
        <svg
          className="sc-row__icon sc-row__icon--noderunner"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
          ...
          <path
            className="sc-row__icon-part"
            d="M12 4.5v5.1M12 14.4v5.1M4.5 12h5.1M14.4 12h5.1"
            stroke="currentColor"
            strokeWidth="1.1"
            strokeLinecap="round"
          />
    ...
    case 'gauntlet':
      return (
        <svg
          className="sc-row__icon sc-row__icon--gauntlet"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
    ...
    case 'ffa':
      return (
        <svg
          className="sc-row__icon sc-row__icon--ffa"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
          ...
          <path
            className="sc-row__icon-part"
            d="M9 7.8h6M9 16.2h6M7.8 9v6M16.2 9v6"
            stroke="currentColor"
            strokeWidth="0.9"
            strokeLinecap="round"
            opacity="0.55"
    ...
    case 'sovereign-stack':
      return (
        <svg
          className="sc-row__icon sc-row__icon--sovereign"
          viewBox="0 0 24 24"
          fill="none"
          aria-hidden="true"
        >
