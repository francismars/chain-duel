...
addEventListener("keydown", function (event) {
  if (event.key === "Enter" || event.key === " ") {
    if (menu == 1) {
      ...
      window.location.href = "/gamemenu?nostr=true";
    } else if (menu == 3) {
  ...
  if (event.key === "ArrowDown" || event.key === "s") {
    if (menu == 1) {
      ...
      document.getElementById("startgamenostr").style.animationDuration = "0s";
      ...
      document.getElementById("highscoresbutton").style.animationDuration =
        "2s";
    } else if (menu == 4) {
      menu = 5;
      document.getElementById("highscoresbutton").style.animationDuration =
  ...
  if (event.key === "ArrowRight" || event.key === "d") {
    if (menu == 2) {
      menu = 2.1;
      document.getElementById("startgamenostr").style.animationDuration = "2s";
      document.getElementById("startgame").style.animationDuration = "0s";
    }
  }
