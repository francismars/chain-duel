...
export function modalHintsFor(
  ...
  return {
    lightning:
      'Lightning (LNURL): tournament buy-in uses standard Lightning invoices and QR-style links from the tournament screens—same idea as P2P duels, scaled for brackets.',
    nostr:
