  ...
  if (body.lnurlw) {
    ...
    for (let payLink of body) {
      ...
      if (payLink.description == "Player 1") {
        ...
        document.getElementById("mindepP1_").innerText = parseInt(
          payLink.min
        ).toLocaleString();
...
function changeTextAfterPayment() {
  ...
  document.getElementById("player1sats").innerText =
    playersSats[0].toLocaleString();
